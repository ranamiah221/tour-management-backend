...
const now = new Date();
const savenDaysAgo = new Date(now).setDate(now.getDate() - 7);
...
const getTourStats = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalTourTypePromise = tour_model_1.Tour.aggregate([
    ...
    const [totalTour, totalTourType, avgTourCost, totalTourByDivision, totalHighestBookedTour] = yield Promise.all([
        totalTourPromise,
...
const getBookingStats = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return {
        totalBooking, totalBookingByStatus, bookingsPerTour, avgGuestCountPerBooking, bookingsLast7Days, bookingsLast30Days, totalBookingByUniqueUsers
    };
});
