...
const successPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updatedBooking = yield booking_model_1.Booking.findByIdAndUpdate(updatedPayment === null || updatedPayment === void 0 ? void 0 : updatedPayment.booking, { status: booking_interface_1.BOOKING_STATUS.COMPLETE }, { new: true, runValidators: true, session }).populate("tour", "title")
        ...
        session.endSession();
        return { success: true, message: "Payment Completed Successfull." };
    }
    catch (error) {
...
const failPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield booking_model_1.Booking.findByIdAndUpdate(updatedPayment === null || updatedPayment === void 0 ? void 0 : updatedPayment.booking, { status: booking_interface_1.BOOKING_STATUS.FAILD }, { new: true, runValidators: true, session });
        yield session.commitTransaction();
        session.endSession();
