...
const createBooking = (payload, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!(tour === null || tour === void 0 ? void 0 : tour.costFrom)) {
            throw new AppError_1.default(http_status_codes_1.default.BAD_GATEWAY, "No Tour Cost Found!");
        }
        const amount = Number(payload.guestCount) * Number(tour.costFrom);
        const booking = yield booking_model_1.Booking.create([Object.assign({ user: userId, status: booking_interface_1.BOOKING_STATUS.PANDING }, payload)], { session });
